...
resource "aws_security_group" "postgresql" {
  ...
  name        = format("%s-%s-postgresql", local.service, local.environment)
...
resource "aws_security_group" "redis" {
  ...
  name        = format("%s-%s-redis", local.service, local.environment)
  vpc_id      = data.aws_vpc.vpc.id
...
resource "aws_security_group" "external-lb" {
  ...
  name        = format("%s-%s-external-lb", local.service, local.environment)
  vpc_id      = data.aws_vpc.vpc.id
...
resource "aws_security_group" "internal-lb" {
  ...
  name        = format("%s-%s-internal-lb", local.service, local.environment)
  vpc_id      = data.aws_vpc.vpc.id
...
resource "aws_security_group_rule" "internal-lb-ingress-proxy-http" {
  ...
  cidr_blocks = local.internal_http_cidr_blocks
}
...
resource "aws_security_group_rule" "internal-lb-ingress-proxy-https" {
  ...
  cidr_blocks = local.internal_https_cidr_blocks
}
...
resource "aws_security_group_rule" "internal-lb-ingress-manager" {
  ...
  cidr_blocks = local.manager_cidr_blocks
}
...
resource "aws_security_group_rule" "internal-lb-ingress-portal-gui" {
  ...
  cidr_blocks = local.portal_cidr_blocks
}
